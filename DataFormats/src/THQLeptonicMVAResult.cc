...
namespace flashgg {
    THQLeptonicMVAResult::THQLeptonicMVAResult () :
        leadJet                (),
        subleadJet             (),
        subsubleadJet          (),
        leadJet_ptr            (),
        ...
        thqLeptonicMvaResult_value     ( -9999. ),
        thqLeptonicMvaResult_value_bdt ( -9999. ),
        thqLeptonicMvaResult_value_bdtg( -9999. )
    {}
    
    THQLeptonicMVAResult::THQLeptonicMVAResult( edm::Ptr<THQLeptonicMVAResult> x )
    {
        leadJet          = x->leadJet;
        ...
        // THQLEPTONIC MVA results different methods
        // need to be remove at some point ?
        thqLeptonicMvaResult_value      = x->thqLeptonicMvaResult_value;
        thqLeptonicMvaResult_value_bdt  = x->thqLeptonicMvaResult_value_bdt;
        thqLeptonicMvaResult_value_bdtg = x->thqLeptonicMvaResult_value_bdtg;
    }
}
// Local Variables:
// mode:c++
