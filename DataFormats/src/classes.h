...
namespace  {
    struct dictionary {
        ...
        flashgg::THQLeptonicMVAResult thqleptonic_res;
        std::vector<flashgg::THQLeptonicMVAResult> vec_thqleptonic_res;
        edm::Wrapper<std::vector<flashgg::THQLeptonicMVAResult> > wrp_vec_thqleptonic_res;
